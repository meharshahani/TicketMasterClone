...
public class Horror extends HttpServlet{
	private String id;
	private String name;
	...
	//public Horror(String name, double price, String image, String retailer, String condition,double discount)
		public Horror(String name, double price, String image, String retailer,String runtime,String summary, String ProductType)
	{
		this.name=name;
		this.price=price;
		this.image=image;
