...
public class DealMatchesUtilities extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.print("<a href='#'>Welcome to TicketMaster </a></h2>");
		
		pw.print("<div class='entry'>");
		pw.print("<img src='images/coms/toystory.jpg'style='width: 600px; display: block; margin-left: auto; margin-right: auto' />");


		pw.print("<br> <br>");
		pw.print("<h2>Book your tickets faster than ever</h2>");
		pw.print("<br> <br>");
		...
		pw.print("<br> <br>");
			...
			BufferedReader reader = new BufferedReader(new FileReader (new File(TOMCAT_HOME+"\\webapps\\TicketMaster\\DealMatches.txt")));
