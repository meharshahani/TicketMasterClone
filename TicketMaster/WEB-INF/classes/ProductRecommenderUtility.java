...
public class ProductRecommenderUtility{
	...
	public HashMap<String,String> readOutputFile(){
		...
		try {
            ...
            br = new BufferedReader(new FileReader(new File(TOMCAT_HOME+"\\webapps\\TicketMaster\\output.csv")));
	...
	public static Product getProduct(String product){
		...
		try 
		{
			...
			{	
				...
				prodObj = new Product(rs.getString("Id"),rs.getString("productName"),rs.getDouble("productPrice"),rs.getString("productImage"),rs.getString("productManufacturer"),rs.getString("ProductType"));
			}
			rs.close();
			pst.close();
			conn.close();
