...
public class Payment extends HttpServlet {
		...
		String theatre = session.getAttribute("theatre").toString();
		
		String row  = session.getAttribute("row").toString();
		String moviename = session.getAttribute("movie_name").toString();

		String userAddress=request.getParameter("userAddress");
		String creditCardNo=request.getParameter("creditCardNo");
		String date_place=request.getParameter("date_place");
		...
		if(message.equals("Successfull"))
		{
			if (msg.equals("good"))
			{
				...
				pw.print("Tickets: " + num_tickets);
				pw.print("<br>");
				pw.print("Movie Name: " + moviename);
				pw.print("<br>");
				pw.print("Row: "+ row);
				pw.print("<br>");
				pw.print("Theatre: " + theatre);
				pw.print("<br>");
				pw.print("</h2>");
