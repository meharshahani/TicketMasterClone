...
public class Registration extends HttpServlet {
	...
	// 		try
	// 		{
 	// 		//  FileInputStream fileInputStream = new FileInputStream(new File(TOMCAT_HOME+"\\webapps\\Assignment1_old\\UserDetails.txt"));
	...
	// 		 //    FileOutputStream fileOutputStream = new FileOutputStream(TOMCAT_HOME+"\\webapps\\Assignment1_old\\UserDetails.txt");
	...
	protected void displayRegistration(HttpServletRequest request,
		...
		pw.print("<form method='post' action='Registration'>"
				...
				+ "</td></tr><tr><td>"
				+ "<h3>User Type</h3></td><td><select name='usertype' class='input'><option value='customer' selected>Customer</option><option value='retailer'>Salesman</option><option value='manager'>Storage Manager</option></select>"
				+ "</td></tr></table>"
