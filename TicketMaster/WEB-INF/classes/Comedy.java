...
public class Comedy extends HttpServlet{
	...
	//public Comedy(String name, double price, String image, String retailer,String condition,double discount)
	public Comedy(String name, double price, String image, String retailer,String runtime,String summary,String ProductType)
	{
		this.name=name;
		this.price=price;
		this.image=image;
